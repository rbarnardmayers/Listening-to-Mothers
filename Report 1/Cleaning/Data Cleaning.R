...
LTM2 <- LTM1 %>% 
  mutate(
    ...
    MEDINDUCE5 = case_when(MEDINDUCE5 >= 999 ~ NA, 
                           TRUE ~ MEDINDUCE5),
    PLANNEDFEED_ONLY = case_when(PLANNEDFEEDC3 == 1 ~ "UNKNOWN", 
                                 PLANNEDFEEDC4 == 1 ~ "UNKNOWN",
                                 PLANNEDFEEDC1 == 1 & PLANNEDFEEDC2 == 1 ~ "Both", 
                                 PLANNEDFEEDC1 == 1 & PLANNEDFEEDC2 == 0 ~ "Breastmilk", 
                                 PLANNEDFEEDC1 == 0 & PLANNEDFEEDC2 == 1 ~ "Formula", 
                                 TRUE ~ "UNKNOWN"),
    FEED1WEEK_ONLY = case_when(FEED1WEEKC3 == 1 ~ "UNKNOWN",
                               FEED1WEEKC1 == 1 & FEED1WEEKC2 == 1 ~ "Both",
    ...
    CURRENTFEED_ONLY = case_when(CURRENTFEEDC1 == 1 & 
                                   CURRENTFEEDC2 == 0 & 
                                   CURRENTFEEDC3 == 0 & 
                                   CURRENTFEEDC4 == 0 &
                                   CURRENTFEEDC5 == 0 & 
                                   FEED1WEEK_ONLY == "Breastmilk" ~ "Breastmilk", 
                                 TRUE ~ "Other"),
    EXCL_BF_3MONTH = case_when(EXCLUSIVEBF < 12 ~ 0, 
                               EXCLUSIVEBF >= 12 ~ 1, 
                               CURRENTFEED_ONLY == "Breastmilk" ~ 1),
    EXCL_BF_6MONTH = case_when(EXCLUSIVEBF < 24 ~ 0, 
                               EXCLUSIVEBF >= 24 ~ 1, 
                               CURRENTFEED_ONLY == "Breastmilk" ~ 1),
    ANY_BF_3MONTH = case_when(WEAN < 12 ~ 0, 
                              WEAN >= 12 ~ 1, 
                              CURRENTFEEDC1 == 1 ~ 1),
    ANY_BF_6MONTH = case_when(WEAN < 24 ~ 0, 
                              WEAN >= 24 ~ 1, 
                              CURRENTFEEDC1 == 1 ~ 1),
    ...
    RMODE = case_when(MODE == 1 ~ 0, 
                     MODE == 2 ~ 1),
    RMODE2 = case_when(MODE2 == 1 ~ 0, 
                      MODE2 == 2 ~ 1),
    RMODE3 = case_when(MODE3 == 1 ~ 0, 
                      MODE3 == 2 ~ 1),
    RMODE4 = case_when(MODE4 == 1 ~ 0, 
                      MODE4 == 2 ~ 1),
    RMODE5 = case_when(MODE5 == 1 ~ 0, 
                      MODE5 == 2 ~ 1),
    RMODE6 = case_when(MODE6 == 1 ~ 0, 
                      MODE6 == 2 ~ 1),
    RMODE7 = case_when(MODE7 == 1 ~ 0, 
                      MODE7 == 2 ~ 1),
    RMODE8 = case_when(MODE8 == 1 ~ 0, 
                      MODE8 == 2 ~ 1),
    RMODE9 = case_when(MODE9 == 1 ~ 0, 
                      MODE9 == 2 ~ 1),
    RMODE10 = case_when(MODE10 == 1 ~ 0, 
                       MODE10 == 2 ~ 1),
    RMODE11 = case_when(MODE11 == 1 ~ 0, 
                       MODE11 == 2 ~ 1),
    RMODE12 = case_when(MODE12 == 1 ~ 0, 
                       MODE12 == 2 ~ 1),
    RMODE13 = case_when(MODE13 == 1 ~ 0, 
                       MODE13 == 2 ~ 1),
    RMODE14 = case_when(MODE14 == 1 ~ 0, 
                       MODE14 == 2 ~ 1),
    ...
    VAGEXAM_5 = case_when(VAGEXAM <= 5 ~ 0, 
                          VAGEXAM > 5 & VAGEXAM <= 10 ~ 1),
    ...
    LABORPERMIT_A1_R = case_when(LABORPERMIT_A1 == 1 ~ 1, 
                                 TRUE ~ 0), 
    LABORPERMIT_A2_R = case_when(LABORPERMIT_A2 == 1 ~ 1, 
                                 TRUE ~ 0),
    PROVIDER_R = case_when(PROVIDER == 4 ~ 1, 
                           TRUE ~ 0)) %>% 
  rename(SONEEDC11 = SOCIALNEEDC11,
