...
fig_1_28 <- collapse.2by2(c('PREGCONDITIONC1','PREGCONDITIONC2','PREGCONDITIONC3',
                            'PREGCONDITIONC4','PREGCONDITIONC5','PREGCONDITIONC6',
                            'PREGCONDITIONC7','PREGCONDITIONC8','PREGCONDITIONC9',
                            'PREGCONDITIONC10'), "RACE")

fig_1_29 <- collapse.2by2(c('PREGCONDITIONC1','PREGCONDITIONC2','PREGCONDITIONC3',
                            'PREGCONDITIONC4','PREGCONDITIONC5','PREGCONDITIONC6',
                            'PREGCONDITIONC7','PREGCONDITIONC8','PREGCONDITIONC9',
                            'PREGCONDITIONC10'), "INSURANCE")
...
fig_1_52 <- print.cont('WEIGHTGAIN')
fig_1_53 <- print.cont('BMI')
...
fig_2_16 <- print.fig('SDM')
fig_2_17 <- fig.2by2('SDM', 'RACE')
fig_2_18 <- fig.2by2('SDM', 'INSURANCE')

# INDUCE5 by SDM induction ----
fig_2_19 <- fig.2by2('INSURANCE', 'SDM')
...
# POSITIONCHOICE 
fig_2_23 <- print.fig('POSITION', data = subset(LTM_dsn, MODE == "Vaginal birth"))
fig_2_24 <- fig.2by2('POSITION', 'POSITIONCHOICE', data = subset(LTM_dsn, MODE == "Vaginal birth"))
...
fig_2_35 <- print.fig('phys_cb')
fig_2_36 <- fig.2by2('BIRTHATTEND', 'phys_cb')
fig_2_37 <- fig.2by2('DOULAC2', 'phys_cb')
...
# Who met the criteria (5% in CA in 2016 births) 
# Midwife and Doula 
